...
# try() fonksiyonuna verilen "westindia" parametresi sayesinde 
# regex() fonksiyonu false döndüğünde condition değeri varsayılan 
# olarak "westindia" olacak ve kondisyon sağlanacak.
variable "resource_group_location" {
  description = "Resource Group Location"
  type        = string
  default     = "eastus"
  validation {
    condition     = try(regex("india$", var.resource_group_location), "westindia")
